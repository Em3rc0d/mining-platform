...
async function seedData() {
  ...
  for (let i = 0; i < tickers.length; i++) {
    ...
    try {
      ...
      const fallbackData: Record<string, any> = {
        BHP: { name: 'BHP Group', country: 'Australia', market_cap: 140000000000 },
        RIO: { name: 'Rio Tinto', country: 'UK', market_cap: 110000000000 },
        FCX: { name: 'Freeport-McMoRan', country: 'USA', market_cap: 70000000000 },
        NEM: { name: 'Newmont Corporation', country: 'USA', market_cap: 55000000000 },
        GOLD: { name: 'Barrick Gold', country: 'Canada', market_cap: 35000000000 },
        SCCO: { name: 'Southern Copper', country: 'Peru', market_cap: 90000000000 },
      }
      companies.push({
        id: i + 1,
        ticker,
  ...
  const operations: Operation[] = [
    ...
    { id: 2, portfolio_id: 1, ticker: 'RIO', operation_type: 'BUY', quantity: 300, price: 60.50, total_value: 18150, commission: 0, notes: null, operation_date: new Date().toISOString() },
    { id: 3, portfolio_id: 2, ticker: 'FCX', operation_type: 'BUY', quantity: 800, price: 40.10, total_value: 32080, commission: 0, notes: null, operation_date: new Date().toISOString() },
    ...
    { id: 5, portfolio_id: 3, ticker: 'NEM', operation_type: 'BUY', quantity: 1000, price: 36.80, total_value: 36800, commission: 0, notes: null, operation_date: new Date().toISOString() },
    { id: 6, portfolio_id: 3, ticker: 'GOLD', operation_type: 'BUY', quantity: 2000, price: 15.40, total_value: 30800, commission: 0, notes: null, operation_date: new Date().toISOString() },
